...
Generating models and fitting them to data.
----------------------
...
.. toctree::
   ...
   Generating models </notebooks/fitdata/GridSearch.ipynb>
   Fitting models to data </notebooks/fitdata/GridSearch.ipynb>
